	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body modal-body-md">
				...
				<form action="{{ route('admin.studentStore') }}" method="post" class="mt-3" enctype="multipart/form-data">
					@csrf
	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body modal-body-md">
				...
				<form action="/admin/student/{{$student->id}}" method="POST" class="mt-2" enctype="multipart/form-data">
					@csrf
					@method('PATCH')
									...
									<div class="form-group">
										...
										<div class="form-control-wrap">
											<div class="form-file">
												...
												<label class="form-file-label" for="customFile">Choose file</label>
												<input type="hidden" name="oldthumbnail" value="{{$student->thumbnail}}">
											</div>
										</div>
									</div>
								</div>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="/admin/studentpass/{{$student->id}}" method="post">
					@csrf
					@method('PATCH')
