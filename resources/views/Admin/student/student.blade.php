					...
					<div class="toggle-expand-content" data-content="more-options">
						<ul class="nk-block-tools g-3">
							...
							<li class="nk-block-tools-opt">
								...
								<a class="btn btn-primary d-none d-md-inline-flex" data-bs-toggle="modal" href="#student-add">
									<em class="icon ni ni-plus"></em>
									<span>Add</span>
								</a>
							</li>
					...
					<div class="nk-tb-list nk-tb-ulist">
						...
						@foreach ($students as $student)
							...
							<div class="nk-tb-item">
								<div class="nk-tb-col nk-tb-col-check">
									<div class="custom-control custom-control-sm custom-checkbox notext">
										<input type="checkbox" class="custom-control-input" name="uid[]" id="uid{{$student->id}}">
									...
									<a href="/admin/student/{{$student->id}}">
										<div class="user-card">
											<div class="user-avatar bg-primary">
												@isset($student->thumbnail)
													<img src="{{ asset('storage/'.$student->thumbnail )}}" alt="">
													
												@else
													<span>{{ Str::limit($student->name, 2, '') }}</span>
												@endisset

												{{-- <img src="https://i.pravatar.cc/60?u={{ $student->id }}" alt=""  class=" "> --}}
											</div>
											<div class="user-info">
												<span class="tb-lead"> {{ $student->name }}
