	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body modal-body-md">
				...
				<form action="{{ route('admin.profileUpdate')}}" method="post" class="mt-1" enctype="multipart/form-data">
					@csrf
							...
							<div class="row gy-4">
									...
									<div class="form-group">
										...
										<div class="form-control-wrap">
											<div class="form-file">
												...
												<input type="hidden" name="oldthumbnail" value="{{$authInfo->thumbnail}}">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input 
											type="text" 
											class="form-control @error('displayName') error @enderror" 
											id="display-name" 
