						...
						<a href="#" class="dropdown-toggle me-n1" data-bs-toggle="dropdown">
							<div class="user-toggle">
								...
								<div class="user-info d-none d-xl-block">
									<div class="user-status user-status-active">Teacher</div>
						...
						<div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
							...
							<div class="dropdown-inner">
								<ul class="link-list">
									<li>
										<a 
											href="{{ url('/teacher/teacher-logout') }}"
										...
										<form id="logout-form" action="{{ url('/teacher/teacher-logout') }}" method="POST" style="display: none;">
											@csrf
										</form>
									</li>
								</ul>
