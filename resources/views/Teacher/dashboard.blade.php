...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Dashboard </h3><em>Teacher Panel.</em>
            <div class="nk-block-des text-soft">
                <p>Welcome to DSSM LMS Dashboard.</p>
            </div>
                                ...
                                <div class="data">
                                    <div class="data-group">
                                        ...
                                        <div class="info text-end"><span class="change up text-danger"><em
                                                    class="icon ni ni-arrow-long-up"></em>7.13%</span><br><span>vs. last
                                                week</span></div>
                                    </div>
                                </div>
                            </div><!-- .card-inner -->
