<div class="nk-sidebar nk-sidebar-fixed is-light " data-content="sidebarMenu">
	<div class="nk-sidebar-element nk-sidebar-head">
		<div class="nk-sidebar-brand">
			<a href="{{ url('/teacher/dashboard') }}" class="logo-link nk-sidebar-logo">
				<img 
			...
			<div class="nk-sidebar-menu" data-simplebar>
				<ul class="nk-menu">
					<li class="nk-menu-item">
						<a href="{{ route('teacher.dashboard') }}" class="nk-menu-link">
					...
					<li class="nk-menu-item">
						<a href="{{ route('teacher.student') }}" class="nk-menu-link">
					...
					<li class="nk-menu-item">
						<a href="{{ route('instructor.profile') }}" class="nk-menu-link">
							<span class="nk-menu-icon">
								<em class="icon ni ni-account-setting-fill"></em>
							</span>
							<span class="nk-menu-text">Teacher profile</span>
						</a>
					</li><!-- .nk-menu-item -->
